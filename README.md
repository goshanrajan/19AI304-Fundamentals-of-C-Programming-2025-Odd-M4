...
void validateDate()
{
    ...
    {
        if ((isLeap && dd > 29) || (!isLeap && dd > 28) || dd < 1)
        {
            printf("Date is invalid\n");
            return;
        }
...
```
# Output: 
<img width="1793" height="662" alt="image" src="https://github.com/user-attachments/assets/a9e140a8-bcba-4a36-9e62-bd8dfefef969" />
...
```
# Output:
<img width="1417" height="604" alt="image" src="https://github.com/user-attachments/assets/37945bae-8e57-4a5a-9da3-974c88da22e9" />
...
```
# Output:
<img width="1691" height="714" alt="image" src="https://github.com/user-attachments/assets/11a1f23a-c621-4f4a-be03-5642fe14a5bd" />
...
```
# Output:
<img width="1670" height="685" alt="image" src="https://github.com/user-attachments/assets/0038d905-6308-4e57-91ca-4fbfdd04aecf" />
...
```
# Output:
<img width="1699" height="677" alt="image" src="https://github.com/user-attachments/assets/9c6b97c5-f8d5-4c2c-bde2-3ac692c2ea32" />
